...
$(document).ready(function () {
  ...
  //   canvasMouseX = parseInt(e.clientX - canvasOffsetX);
  //   canvasMouseY = parseInt(e.clientY - canvasOffsetY);
  //   isDragging = true;
  ...
  //   if (isDragging && userFile) {
  //     const url = await getFileAsURL(userFile);
  //     const img = new Image();
  ...
  //     context.drawImage(
  //       img,
  //       canvasMouseX - img.width / 2 + 100,
  //       // canvasMouseX,
  //       canvasMouseY + img.height + 650,
  //       // canvasMouseY,
